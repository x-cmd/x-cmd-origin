...
function str_hextodec(h) {
	h = toupper(h)
	return 256 * __HEX[substr(h, 1, 2)] + __HEX[substr(h, 3)]
}


function str_unescape(s) {
    return _str_unescape(substr(s, 2, length(s)-2))
}

function _str_unescape(s,   i, s2, c, u, h) {
